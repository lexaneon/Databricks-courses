...
# DBTITLE 0,--i18n-4fa53ae2-05c8-4f70-a77f-86f8301e8790
# MAGIC %md
...
destination_path = f"/Users/{DA.username}/imported_notebooks/demo-ML-09-AutoML-{datetime.now().strftime('%Y%m%d%H%M%S')}"
